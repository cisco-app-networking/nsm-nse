...
day0=$(sed -e "s/<PEER_CONNECT_IP>/${IP_ADDR}/g" -e "s/<HOST_NETWORK>/$SUBNET_IP/g" "scripts/ucnf-kiknos/day0.txt")

# Deploy ASA
python  scripts/ucnf-kiknos/pyaws/create_ec2.py --name kiknos-asa --key-pair "$AWS_KEY_PAIR" \
...
python  scripts/ucnf-kiknos/pyaws/create_ec2.py --name kiknos-client --key-pair "$AWS_KEY_PAIR" \
