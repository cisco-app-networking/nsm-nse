...
pc "${DELETE:+INSTALL_OP=delete} HELMDIR=${ISTIOHELMDIR} KCONF=${KCONF_CLUS1} KCONF_KIND=${SVCREGKUBECONFIG} scripts/vl3/istio.sh"

pe "# Install Istio in cluster 2"
pc "${DELETE:+INSTALL_OP=delete} HELMDIR=${ISTIOHELMDIR} KCONF=${KCONF_CLUS2} KCONF_KIND=${SVCREGKUBECONFIG} scripts/vl3/istio.sh"
...
pc "${DELETE:+INSTALL_OP=delete} REMOTE_IP=${clus2_IP} KCONF=${KCONF_CLUS1} scripts/vl3/vl3_interdomain.sh"

pe "# Install vL3 + helloworld clients in cluster 2"
pc "${DELETE:+INSTALL_OP=delete} REMOTE_IP=${clus1_IP} KCONF=${KCONF_CLUS2} scripts/vl3/vl3_interdomain.sh"
